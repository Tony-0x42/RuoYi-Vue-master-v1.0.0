<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item :label="$t('oa.knowledgebase.categoryName')" prop="name">
        <el-input
          ...
          :placeholder="$t('oa.knowledgebase.categoryName')"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['oa:knowledgebaseCategory:add']"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['oa:knowledgebaseCategory:edit']"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['oa:knowledgebaseCategory:remove']"
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('oa.knowledgebase.categoryName')" align="center" prop="name" />
      <el-table-column :label="$t('oa.knowledgebase.categoryCode')" align="center" prop="code" />
      <el-table-column :label="$t('common.status')" align="center" prop="status" width="100">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.status === 1" type="success">{{ $t('oa.knowledgebase.enable') }}</el-tag>
          <el-tag v-else type="danger">{{ $t('oa.knowledgebase.disable') }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm(this.$t('oa.knowledgebase.confirm.deleteCategory', { ids })).then(function() {
